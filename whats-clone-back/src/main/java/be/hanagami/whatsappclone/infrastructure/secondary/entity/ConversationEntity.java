...
import be.hanagami.whatsappclone.infrastructure.secondary.entity.ConversationEntityBuilder;
import be.hanagami.whatsappclone.messaging.domain.message.aggregate.Conversation;
import be.hanagami.whatsappclone.messaging.domain.message.aggregate.ConversationBuilder;
...
public class ConversationEntity extends AbstractAuditingEntity<Long> {
    ...
    private static ConversationEntity from(ConversationToCreate conversation){
        ConversationEntityBuilder conversationEntityBuilder = ConversationEntityBuilder.conversationEntity();
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(publicId, that.publicId) && Objects.equals(name, that.name) && Objects.equals(messages, that.messages) && Objects.equals(users, that.users);
    }
